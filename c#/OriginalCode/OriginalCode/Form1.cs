...
namespace OriginalCode
{
    public partial class Form1 : Form
    {
        ...
        {
            labelFaceDetection.Text = "detect face: " + facesDetectionEnabled;
            labelSaveFace.Text = "save face: " + EnableSaveImage;
            labelFaces.Text = "faces: 0";
            ...
            if (videoCapture != null && videoCapture.Ptr != IntPtr.Zero)
            {
                ...
                if (facesDetectionEnabled)
                {
                    ...
                    //If faces detected
                    labelFaces.Text = "faces: " + faces.Length;
                    if (faces.Length > 0)
                    {
