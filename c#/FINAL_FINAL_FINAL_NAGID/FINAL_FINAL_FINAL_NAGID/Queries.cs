...
namespace FINAL_FINAL_FINAL_NAGID
{
    class Queries
    {
        ...
        public bool createRecord(String lastname, String firstname, String middlename, String department, String status)
        {
            try
            {
                ...
                comm.CommandText = "INSERT INTO records (lastname, firstname, middlename, department, status) VALUES (@lastname, @firstname, @middlename, @department, @status)";
        ...
        public NpgsqlDataReader getRecords()
        {
            ...
            comm.Connection = conn;
            comm.CommandType = CommandType.Text;
            comm.CommandText = "SELECT record_id, CONCAT(lastname, ', ', firstname, ' ', middlename) AS fullname, department, status FROM records ORDER BY lastname ASC, firstname ASC, middlename ASC";
            NpgsqlDataReader dr = comm.ExecuteReader();
            comm.Dispose();
            return dr;
        }
